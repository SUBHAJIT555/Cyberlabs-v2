                    ...
                    >
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 py-4">
                            {CERT_ORGS.map((org) => (
                                <motion.div
                                    key={org.name}
                                    className="flex flex-col items-center rounded-lg border border-neutral-300 border-dashed overflow-hidden bg-white p-4 sm:p-6 shadow-sm transition-shadow hover:shadow-md"
                                    style={{
